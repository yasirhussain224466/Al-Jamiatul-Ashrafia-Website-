...
import MakhdoomPak from './Pages/KhanzadaAshrafia/MakhdoomPak.js'
    ...
    <>
      <main>
        <Switch>
          ...
          <Route exact path='/library/books/description' component={BookDescription}/>
          <Route exact path="/library/articles" component={Articles} />
          <Route exact path='/makhdoom_pak' component={MakhdoomPak}/>
